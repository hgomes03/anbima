...
public class SelicServicoImpl implements SelicServico {
	...
	@Override
	public MediaDTO calcularMedia(String ano, List<Selic> taxasPorAno) throws ConstraintException {
		...
		if (taxasPorAno!=null) {
			...
			double m = total / taxasPorAno.size();
			
			media.setAno(Integer.parseInt(ano));
			media.setMedia(m);
		}
